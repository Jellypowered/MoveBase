...
namespace MoveBase
{
    ...
    public static class JobDriver_Uninstall_FinishedRemoving_Patch
    {
        ...
        {
            MethodInfo original = typeof(JobDriver_Uninstall).GetMethod(
                "FinishedRemoving",
                BindingFlags.NonPublic | BindingFlags.Instance
            );
            MethodInfo postfix = typeof(JobDriver_Uninstall_FinishedRemoving_Patch).GetMethod(
                "Postfix",
        ...
        {
            DesignatorMoveBase.UninstallJobCallback(
