...
namespace HomeMover
{
    public static class HarmonyUtility
    {
        ...
        public static class HomeMover_Startup
        {
            static HomeMover_Startup()
            {
                var harmony = new Harmony("Jellypowered.HomeMover");
                harmony.PatchAll();
                HomeMoverMod.DebugLog("Harmony patches applied.");
